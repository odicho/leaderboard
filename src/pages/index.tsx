...
export default function Dashboard() {
  ...
  const setRun = trpc.run.setRun.useMutation({
    onMutate: async (newRun) => {
      ...
      await utils.user.getAllusersAndSumDistance.cancel();
  ...
  return (
    <>
          ...
          <div className="flex w-full flex-col items-center sm:w-[600px]">
            ...
            <div className="flex w-[300px] flex-col items-center gap-3 py-2 sm:w-[370px] sm:flex-row sm:justify-between">
              <input
                ...
                value={activityInput}
                className="w-[180px] rounded border px-4 py-2 focus:outline focus:outline-1 focus:outline-blue-700"
                maxLength={30}
                onChange={(e) => {
              ...
              <div className="flex gap-1">
                <input
                  className="w-24 rounded border px-4 py-2 text-end focus:outline focus:outline-1 focus:outline-blue-700"
                  type="number"
                  min={0}
                  step={0.01}
                  placeholder="0"
      ...
      <div className="flex flex-col items-center justify-center px-4 pb-10 pt-20 text-[#111111] sm:px-10">
        ...
        <div className="grid w-full gap-10 sm:w-fit sm:max-w-7xl sm:grid-cols-3 sm:gap-10 md:grid-cols-4 lg:grid-cols-6">
          {dataAvailable &&
